      ...
      >
        <router-link to="/">
          <a
            ...
            href="#pablo"
          >
           <img class=" h-10 w-48" src="@/assets/images/Logo(2).png" alt="" width="auto">
          </a>
        </router-link>
        <button
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center ml-5">
            <router-link to="/login" >
              <button
              class="bg-green-600 hover:bg-green-900 text-white active:bg-green-600 text-sm font-bold uppercase px-5 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
              type="button"
            >
