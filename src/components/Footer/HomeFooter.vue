  ...
  <div class="relative mt-16 bg-gray-900">
    ...
    <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <!-- <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        <div class="md:max-w-md lg:col-span-2 text-left">
        ...
        <div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4 text-left">
          <div>
          ...
          <div>
            ...
            <ul class="mt-2 space-y-2">
              ...
              <li>
                <a href="/" class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">Terms and Conditions</a>
              </li>
              <li>
      ...
      <div class="flex flex-col justify-between pt-5 pb-10 border-t border-green-600 sm:flex-row">
        <p class="text-sm text-gray-100">
          © Copyright 2021 The Guide. All rights reserved.
        </p>
        <div class="flex items-center mt-4 space-x-4 sm:mt-0">
          <a href="/" class="transition-colors duration-300 text-green-600 hover:text-teal-green-600">
          ...
          <a href="/" class="transition-colors duration-300 text-green-600 hover:text-green-600">
